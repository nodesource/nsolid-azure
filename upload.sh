...
az storage blob upload --container-name public --name nsolid-quick-start/nsolid-deploy.json --file templates/nsolid-quick-start.json --account-name nodesourcearmtemplates
